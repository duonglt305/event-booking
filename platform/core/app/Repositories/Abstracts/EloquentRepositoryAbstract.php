 ...
 *
 * @package    DG\Dissertation\Core
 * @author     Giang Nguyen
 * @author     <mrcatbro97@gmail.com>
 * @date       26/09/2019
 */

namespace DG\Dissertation\Core\Repositories\Abstracts;

use DG\Dissertation\Core\Repositories\Interfaces\EloquentRepositoryInterface;
...
abstract class EloquentRepositoryAbstract implements EloquentRepositoryInterface
{
    ...
    {
        return $this->applyAfterExecute($this->model->updateOrCreate($attributes));
    }
