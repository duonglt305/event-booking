...
/***/ "./platform/admin/resources/assets/js/articles.create-update.js":
/*!**********************************************************************!*\
  !*** ./platform/admin/resources/assets/js/articles.create-update.js ***!
  \**********************************************************************/
/*! no exports provided */
...
function () {
  ...
  _createClass(Articles, [{
    ...
    value: function initFrom() {
      ...
      this.$formArticle.submit(function (event) {
        event.preventDefault();

        _this.$formArticle.find('button[type=submit]').prop('disabled', true);

        var url = $(event.target).attr('action');
        var fd = new FormData(event.target);
        fd.append('body', CKEDITOR.instances.body.getData());
        axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(url, fd).then(function (_ref) {
          var data = _ref.data;

          if (data && data.message) {
            _helpers__WEBPACK_IMPORTED_MODULE_0__["default"].showToast(data.message);
            setTimeout(function () {
              window.location.href = data.redirect;
            }, 1000);
          }
        }, function (err) {
          _this.$formArticle.find('button[type=submit]').prop('disabled', false);
...
/***/ 4:
/*!****************************************************************************!*\
  !*** multi ./platform/admin/resources/assets/js/articles.create-update.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/duongle/www/dissertation/platform/admin/resources/assets/js/articles.create-update.js */"./platform/admin/resources/assets/js/articles.create-update.js");
