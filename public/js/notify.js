...
/***/ "./platform/admin/resources/assets/js/notify.js":
/*!******************************************************!*\
  !*** ./platform/admin/resources/assets/js/notify.js ***!
  \******************************************************/
/*! no exports provided */
...
function () {
  ...
  _createClass(Notify, [{
    ...
    value: function init() {
      ...
      var pusher = new Pusher(this.$navBarNotifyNum.data('app-key'), {
        cluster: this.$navBarNotifyNum.data('app-cluster'),
        encrypted: true
      });
      var channel = pusher.subscribe('notify-channel');
      channel.bind('DG\\Dissertation\\Admin\\Events\\NotifyRegistration', function (data) {
        var organizer = parseInt(data.event.organizer_id);

        if (organizer === parseInt(_this.$notificationContainer.data('o-id'))) {
          var items = _this.$notificationContainer.find('a').toArray();

          var num = parseInt(_this.$navBarNotifyNum.text());
          ...
          var html = "<a class=\"dropdown-item preview-item\">\n                            <div class=\"preview-item-content flex-grow py-2\">\n                                <p class=\"font-weight-medium text-dark\">\n                                    Attendee just register to event now\n                                </p>\n                                <p class=\"font-weight-light small-text\">\n                                    <strong>".concat(data.attendee.firstname, " ").concat(data.attendee.lastname, "</strong> just register to event <strong>").concat(data.event.name, "</strong>\n                                </p>\n                                <p class=\"text-muted text-right\" style=\"font-size: 12px!important;\">\n                                    ").concat(moment_timezone__WEBPACK_IMPORTED_MODULE_1___default()(new Date()).tz("Asia/Ho_Chi_Minh").format('D/M/Y HH:mm'), "\n                                </p>\n                            </div>\n                        </a>");

          _this.$notificationContainer.html(html);

          _this.$notificationContainer.append(items);

          _this.$notifySentence.text("You have ".concat(num + 1, " unread notification "));

          _this.$navBarNotifyNum.text(num + 1);
        }
      });
      this.$viewAllNotify.click(function (event) {
        window.location.href = $(event.target).data('url');
      });
      $(document).on('click', '.notification-item', function (event) {
        var id = $(event.currentTarget).data('id');

        var url = _this.$notificationContainer.data('one-url');
...
/***/ 10:
/*!************************************************************!*\
  !*** multi ./platform/admin/resources/assets/js/notify.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/platform/admin/resources/assets/js/notify.js */"./platform/admin/resources/assets/js/notify.js");
