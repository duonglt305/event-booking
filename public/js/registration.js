...
/***/ "./platform/admin/resources/assets/js/registration.js":
/*!************************************************************!*\
  !*** ./platform/admin/resources/assets/js/registration.js ***!
  \************************************************************/
/*! no exports provided */
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers */ "./platform/admin/resources/assets/js/helpers.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(Registration, [{
    ...
    value: function init() {
      ...
      this.initTable();
      this.$dropdownPaid.click(function (event) {
        var status = _this.$dropdownPaid.data('status');

        _this.$dropdownMenuOutlineButton1.text(_this.$dropdownPaid.text());

        _this.status = status;

        _this.$registrationtDatatable.DataTable().ajax.url(_this.$registrationtDatatable.data('url') + '?status=' + _this.resolveStatus()).load();
      });
      this.$dropdownPending.click(function (event) {
        var status = _this.$dropdownPending.data('status');

        _this.$dropdownMenuOutlineButton1.text(_this.$dropdownPending.text());
...
/***/ 13:
/*!******************************************************************!*\
  !*** multi ./platform/admin/resources/assets/js/registration.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/platform/admin/resources/assets/js/registration.js */"./platform/admin/resources/assets/js/registration.js");
