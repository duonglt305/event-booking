...
/***/ "./platform/admin/resources/assets/js/contact.js":
/*!*******************************************************!*\
  !*** ./platform/admin/resources/assets/js/contact.js ***!
  \*******************************************************/
/*! no exports provided */
...
function () {
  ...
  _createClass(Contact, [{
    ...
    value: function initMaskAsRead() {
      ...
      $(document).on('click', '.mask-as-read', function (event) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, {
          ...
          if (res.data && res.data.message) {
            _helpers__WEBPACK_IMPORTED_MODULE_1__["default"].showToast(res.data.message);
          }

          _this.$contactDatatable.DataTable().ajax.reload();
        }, function (err) {
          _helpers__WEBPACK_IMPORTED_MODULE_1__["default"].showToast(err.response.data.message, 'error');
        });
      });
      this.$maskAsReadAll.click(function (event) {
...
/***/ 12:
/*!*************************************************************!*\
  !*** multi ./platform/admin/resources/assets/js/contact.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/platform/admin/resources/assets/js/contact.js */"./platform/admin/resources/assets/js/contact.js");
