...
/***/ "./platform/admin/resources/assets/js/event.report.js":
/*!************************************************************!*\
  !*** ./platform/admin/resources/assets/js/event.report.js ***!
  \************************************************************/
/*! no exports provided */
...
function () {
  ...
  _createClass(EventReport, [{
    ...
    value: function getData() {
      ...
      return new Promise(function (resolve, reject) {
        axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("/organizer/events/".concat(_this2.$eventName.data('event'), "/report")).then(function (res) {
          resolve(res.data);
        }, function (err) {
          reject(err);
        });
    ...
    key: "getDataSessions",
    value: function getDataSessions() {
      var _this3 = this;

      return new Promise(function (resolve, reject) {
        axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(_this3.$sessionDetail.data('url')).then(function (res) {
          resolve(res.data);
        }, function (err) {
          reject(err);
        });
    ...
    key: "getDataRegistration",
    value: function getDataRegistration(from, to) {
      var _this4 = this;

      return new Promise(function (resolve, reject) {
        axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(_this4.$attendeeRegistrationDetail.data('url'), {
          from: from,
          to: to
        }).then(function (res) {
          resolve(res.data);
    ...
    key: "ticketReport",
    value: function ticketReport(tickets) {
      var _this5 = this;

      var html = tickets.reduce(function (current, next) {
        var total = 0;

        var color = _this5.colors[Math.round(Math.random() * (_this5.colors.length - 1))];
        ...
        if (next.special_validity === null) {
          ...
          var type = next.special_validity.type;
        ...
        return current + "<tr>\n                        <td>\n                            ".concat(next.name, "\n                        </td>\n                        <td>\n                        <div class=\"progress\">\n                        <div class=\"progress-bar ").concat(color, "\" role=\"progressbar\" style=\"width: ").concat(percent, "%\" aria-valuenow=\"24\" aria-valuemin=\"0\" aria-valuemax=\"100\"></div>\n                        </div>\n                        </td>\n                        <td>").concat(booked, "</td>\n                        <td>").concat(total, "</td>\n                    </tr>");
      }, '');
    ...
    key: "roomReport",
    value: function roomReport(rooms) {
      var roomName = rooms.reduce(function (current, next) {
        return current + "<p class=\"text-muted ml-3 list-item\">".concat(next.name, "</p>");
      }, '');
      var html = "<h1 class=\"font-weight-medium mb-3\">".concat(rooms.length, " Rooms</h1>").concat(roomName);
      this.$roomOverview.html(html);
      this.drawRoomChart(rooms);
    }
  }, {
    key: "drawRoomChart",
    value: function drawRoomChart(rooms) {
      new Chart(this.$roomChart[0], {
        type: 'bar',
        data: {
          labels: rooms.map(function (room) {
            return room.name;
          }),
          datasets: [{
            label: 'Capacity',
    ...
    key: "attendeesReport",
    value: function attendeesReport(data) {
      var total = 0;
      var free = 0;
      var premium = 0;
      ...
      if (data.length > 0) {
        data.forEach(function (item) {
          ...
          if (item.cost === 0 || item.cost === null) free += item.registrations.length;else premium += item.registrations.length;
        });
      }

      var percent = Math.round(free / total * 100);
      this.$totalAttendees.text(total);
      this.$attendeesCostPercent.text((percent || 0) + '% is premium registration');
    }
  }, {
    key: "articleReport",
    value: function articleReport(articles) {
      var total = 0;
      var publish = 0;
      var draft = 0;
      var hidden = 0;
      ...
      this.$totalArticlesDetail.text("".concat(publish, " published, ").concat(draft, " draft, ").concat(hidden, " hidden"));
    }
  }, {
    key: "partnersReport",
    value: function partnersReport(partners) {
      this.$totalPartners.text(partners.length);
    }
  }, {
    key: "sessionsReport",
    value: function sessionsReport(data) {
      var registrations = [];
    ...
    key: "sessionRatingsReport",
    value: function sessionRatingsReport(sessions) {
      var html = sessions.reduce(function (current, next) {
        var average = 0;
        var percent = 0;
        var totalRatings = 0;
        ...
        if (next.session_ratings.length > 0) {
          ...
          average = next.session_ratings.reduce(function (current, next) {
            return current + next.rate;
          }, 0) / totalRatings;
          percent = (average / 5 * 100).toFixed(2);
        }

        return current + "<tr>\n                        <td>".concat(next.title, "</td>\n                        <td>\n                        <div class=\"row\">\n                        <div class=\"col-11\">\n                            <div class=\"progress\">\n                                <div class=\"progress-bar bg-success\" role=\"progressbar\" style=\"width: ").concat(percent, "%\" aria-valuenow=\"").concat(percent, "\" aria-valuemin=\"0\" aria-valuemax=\"5\"></div>\n                            </div>\n                        </div>\n                        <div class=\"col-1\">").concat(average, "/5</div>\n                        </div>\n                        </td>\n                        <td class=\"text-center\">\n                            ").concat(totalRatings, " ratings\n                        </td>\n                    </tr>");
      }, '');
    ...
    key: "channelReport",
    value: function channelReport(data) {
      var titles = [];
      var rooms = [];
      var sessions = [];
    ...
    key: "attendeeRegistrationReport",
    value: function attendeeRegistrationReport(data) {
...
/***/ 7:
/*!******************************************************************!*\
  !*** multi ./platform/admin/resources/assets/js/event.report.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
